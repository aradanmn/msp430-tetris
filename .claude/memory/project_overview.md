...
**BOM state (Rev C):** 20 line items, total ~$113.85. Potentiometer (Bourns PTV09A-4020F-A103, 10kΩ audio taper) added to Audio Module. CSV has Status column (In Hand / Order / Partial). Files: docs/bom-flat.md, docs/bom-structured.md, docs/bom-order.csv.
